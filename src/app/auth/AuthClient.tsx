    ...
    <>
          ...
          <div className="auth-overlay-panel">
            <div className="auth-overlay-inner">
              ...
              <div className="auth-overlay-side auth-overlay-side--left">
                <div className="auth-logo auth-logo--overlay"><img src="/assets/logo.png" alt="Disconnect Agencies" /></div>
                <h2>Welcome Back!</h2>
      ...
      <div className="auth-page auth-mobile">
        <div className="auth-mobile-inner">
          ...
          >
            <div className="auth-logo auth-logo--mobile"><img src="/assets/logo.png" alt="Disconnect Agencies" /></div>
