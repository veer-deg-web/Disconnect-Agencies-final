...
import PrecisionGrowthGraph from "@/components/Home/PrecisionGrowthGraph/PrecisionGrowthGraph";
        ...
        <div className="growth-leftCol">
          ...
          <div className="growth-card growth-wideCard">
            ...
            <div className="growth-imageRight">
              ...
              >
                <Image
                  src="/assets/Home/GrowthShowcaseSection/photo/Visual.webp"
        ...
        <div className="growth-rightCol">
          ...
          <div className="growth-card growth-smallCard">
            ...
            <div className="growth-imageBottomSmall">
              ...
              >
                <Image
                  src="/assets/Home/GrowthShowcaseSection/photo/dot.webp"
                  alt="Decorative dots"
                  width={180}
                  height={90}
          ...
          <div className="growth-card growth-tallCard">
            ...
            <div className="growth-imageBottomOrbit">
              ...
              >
                <Image
                  src="/assets/Home/GrowthShowcaseSection/photo/Image@2x.webp"
                  alt="Orbit visual"
                  fill
