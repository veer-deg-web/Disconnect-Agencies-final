      ...
      <section className="product-visuals">
        ...
        <div className="visual-wrapper">
          <MacbookScroll
            title={
              <span>
                Designed for modern app experiences. <br /> Built for speed and scale.
              </span>
            }
            badge={
              <a href="https://peerlist.io/manuarora" target="_blank" rel="noreferrer">
                <Badge className="macbook-badge" />
              </a>
            }
            src="/assets/AppDevelopment/ProductVisuals/photo/screenshot.webp"
            showGradient={false}
            className="product-macbook-scroll"
          />
        </div>
      </section>
